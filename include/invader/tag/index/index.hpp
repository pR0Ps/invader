...
namespace Invader {
     ...
     */
    std::vector<File::TagFilePath> demo_indices(const char *map_name);

    /**
     * Get the stock indices for the given map for retail
     * @param map_name scenario name
     */
    std::vector<File::TagFilePath> retail_indices(const char *map_name);

    /**
     * Get the stock indices for the given map for custom edition
     * @param map_name scenario name
     */
    std::vector<File::TagFilePath> custom_edition_indices(const char *map_name);
}
